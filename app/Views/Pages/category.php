        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo ucwords($results['category']);?></li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="row row1">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-12 span1 mr-3">
                ...
                <?php foreach($results['dataapp'] as $result) :?>
                    <div class="col-xl-5 col-lg-5 col-sm-5 col-12 span4 mb-4 ml-4">
                        <a href="<?= base_url();?>/category/<?php echo strtolower($result->cat_name);?>">
                            <div class="d-flex spancenter">
                                <?php if($result->cat_image != NULL) { ?>
                                    <img src="<?= base_url()?>/assets/uploads/appsimages/<?=$result->cat_image;?>"  width = 50 height = 50 >
                                <?php }else { ?>
            ...
            <div class="col-xl-7 col-lg-12 col-sm-12 col-12 span11 mt-3 ml-3">
                <div class="span11 ">
                    <div class="game col-lg-12 col-sm-12 miga d-flex pt-3 pb-3 mb-3">
                        <div class="col-sm-4">
                            <h2 class="for-h3 foraligncenter"><?php echo ucwords($results['category']);?></h2>
                        </div>
                    ...
                    <div class="row row1 pr-3 pl-3">
                        
                        <?php foreach($results['dataAll'] as $raw) : ?>
                        <div class="col-xl-3 col-12 col-sm-3 col-md-4 col-lg-4 span8">
                            <div class=" spancenter span7">
                                ...
                                <div class="content-heading cont-align">
                                    ...
                                    <a href="<?= base_url()?>/store/<?= $raw->app_name;?>"><button class="btn for-btn">Download XAPK</button></a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    ...
                    <?php if(sizeof($results['dataAll']) >= 12 ) : ?>
                        <div class="row shwmre">
                            <div class="col-xl-12 mb-3">
                                <button class="btn for-btn">SHOW MORE</button>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="row shwmre">
                            <button class="btn for-btn">No Games or Apps to be displayed...</button>
                        </div>
                    <?php endif; ?>
