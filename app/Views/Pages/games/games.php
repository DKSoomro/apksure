...
<?= $this->section('content') ?>
    ...
    <section class="container">
        ...
        <div class="col-xl-4 col-lg-12 col-sm-12 col-12 span1 mr-3">
            ...
            <div class="col-xl-7 col-lg-12 col-sm-12 col-12 span11 mt-3 ml-3">
                <div class="span11 ">
                    <div class="game col-lg-12 col-sm-12 miga d-flex pt-3 pb-3 mb-3">
                        <div class="col-sm-4">
                            <h2 class="for-h3 foraligncenter">Games</h2>
                        </div>
                    ...
                    <div class="row row1 pr-3 pl-3" id = 'load_data_table'>
                    ...
                    <div class="row shwmre">
                        <div class="col-xl-12 mb-3" id ='remove_row'>
                            <button class="btn for-btn" id="btn_more" data-vid="<?php echo $counter;?>">SHOW MORE</button>
                        </div>
                    </div>
