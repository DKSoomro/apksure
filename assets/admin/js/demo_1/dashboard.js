(function ($) {
  ...
  $(function () {
    ...
    if ($('#stats-line-graph-1').length) {
      ...
      gradientStrokeFill_1.addColorStop(0, 'rgba(243, 63, 16, 0.4)');
      gradientStrokeFill_1.addColorStop(1, 'rgba(243, 63, 16, 0)');
    ...
    if ($('#stats-line-graph-4').length) {
      ...
      var gradientStrokeFill_1 = lineChartCanvas.createLinearGradient(243, 63,16, 50);
      gradientStrokeFill_1.addColorStop(0, 'rgba(243, 63, 16, 0.4)');
      gradientStrokeFill_1.addColorStop(1, 'rgba(243, 63, 16, 0)');
      var lineChart = new Chart(lineChartCanvas, {
        type: 'line',
